...
class MainActivity : ComponentActivity() {
    ...
    private var notificationDestination by
    ...
    private val notificationPermissionLauncher =
        registerForActivityResult(
            ...
            // Android records the user's notification choice.
        }
    ...
    override fun onCreate(
        ...
        notificationDestination =
            notificationDestinationFrom(intent)

        FirebaseMessaging
            .getInstance()
            .subscribeToTopic(REAPER_LIVE_TOPIC)

        enableEdgeToEdge()

        if (
            LanguagePreferences.hasSelectedLanguage(this)
        ) {
            ...
            ReaperCompanionTheme {
                ...
                if (showSplash) {
                    ...
                    when (currentPage) {
                        ...
                        "buildAround" ->
                            BuildAroundPerkScreen(
                                onBackClick = {
                                    currentPage =
                                        "deadByDaylight"
                                },
                                onPerkClick = { perk ->
                                    selectedBuildAroundPerk =
                                        perk
    ...
    private fun notificationDestinationFrom(
        intent: Intent?
    ): String? {
        val destination =
    ...
    companion object {
        private const val REAPER_LIVE_TOPIC =
            "reaper_live"

        private const val NOTIFICATION_PREFERENCES =
            "reaper_notification_preferences"
